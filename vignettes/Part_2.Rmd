...
In this step we look on expression counts from individual sample perspective. Basically, we ask a question how different our samples are?

In this analysis we have 4 types of terminology we refer to samples:
...
To create your own metadata table and add it to SE object see Appendix A.
...
Now that we have counts and metadata looks good we proceed with Differential expression analysis.
...
PCA allows to get an overall view on gene expression between samples.
```{r pca}
# Manual color
